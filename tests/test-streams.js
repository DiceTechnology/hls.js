  ...
  return fetch(
    'https://shield-api.imggaming.com/admin/v1/ovp/dice/client/dce.sandbox/action/sign_test_content_token',
    {
      ...
      body: JSON.stringify({
        ttl_seconds: 30000,
        claims: {
          eid: '52c6a05f-d29b-48a1-85f2-fe99d6839947',
...
module.exports = {
  ...
  issue7413_widevine_multi_keys: createTestStreamWithConfig(
    {
      url: 'https://sample-videos-zyrkp2nj.s3-eu-west-1.amazonaws.com/big-buck-bunny-variants/30fps-multi-key/hls_fmp4_cenc_pw/master.m3u8',
      description: '#7413 widevine multi keys"',
      abr: true,
  ...
  issue7413_playready_multi_keys: createTestStreamWithConfig(
    {
      url: 'https://sample-videos-zyrkp2nj.s3-eu-west-1.amazonaws.com/big-buck-bunny-variants/30fps-multi-key/hls_fmp4_cenc_pw/master.m3u8',
      description: '#7413 playready multi keys"',
      abr: true,
      skip_ua: ['firefox', 'safari'],
    },
    {
      ...
      licenseXhrSetup: async function (xhr, url, keyContext, licenseChallenge) {
        ...
        xhr.setRequestHeader(
          'x-drm-info',
          'eyJzeXN0ZW0iOiJjb20ubWljcm9zb2Z0LnBsYXlyZWFkeSJ9',
        );
      },
  ...
  issue7413_playready_clear_to_drm: createTestStreamWithConfig(
    {
      ...
      description: '#7413 playready clear to drm',
      abr: true,
      skip_ua: ['firefox', 'safari'],
    },
    {
